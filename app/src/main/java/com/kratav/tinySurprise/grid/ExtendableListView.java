...
public abstract class ExtendableListView extends AbsListView {
    ...
    /**
     * Add a fixed view to appear at the bottom of the list. If toggleFooterViewVisibilty is
     * called more than once, the views will appear in the order they were
     * added. Views added using this call can take focus if they want.
     * <p/>
     * NOTE: Call this before calling setAdapter. This is so ListView can wrap
    ...
    /**
     * Add a fixed view to appear at the bottom of the list. If toggleFooterViewVisibilty is called more
...
//            case TOUCH_MODE_OVERSCROLL:
    ...
    private void updateEmptyStatus() {
        ...
        if (empty) {
            ...
            // We are delDate GONE, so pending layouts will not be dispatched.
