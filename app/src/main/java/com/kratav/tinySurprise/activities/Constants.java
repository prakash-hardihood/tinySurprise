...
public class Constants {
    ...
    //Firebase app url
    public static final String FIREBASE_APP = "https://tinysurprise-1083.firebaseio.com";
    ...
    public static final String REGISTER_URL = "http://tinysurprise.com/test_mode/mobi-app/fcm/register.php";
